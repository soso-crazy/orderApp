...
module.exports = {
    ...
    module: {
        rules: [
            ...
            {
                test: /\.css$/, use: ['css-loader','style-loader'], include: srcRoot
                ...
                test: /\.scss$/, use: ['style-loader', 'css-loader', 'sass-loader',
                    {
                        ...
                        options: {
                            resources: srcRoot + '/component/rem_function'
                        }
                    }
                ], include: srcRoot
            }, //解析sass, 把sass解析成浏览器可以识别的css语言,使用sass-resources-loader全局引入scss文件
            {test: /\.(png|jpg|jpeg)$/, use: 'url-loader?limit=8192', include: srcRoot} //解析图片,limit表示超过多少就使用base64来代替，单位是byte
        ]
    },
